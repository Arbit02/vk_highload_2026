...
Сетевой трафик При расчёте используется коэффициент суточной неравномерности k = 2 для определения пиковой нагрузки.
трафик (k=2) (Гбит/с) |
| Тип трафика | Суточный объём (Тбайт/сут) | Средний трафик (Гбит/с) | Пиковый трафик (k=2) (Гбит/с) |
|-------------|----------------------------|-------------------------|-------------------------------|
| Текстовые данные | 14 млн отзывовов * 350 байт = 0,0049| ? | ? |
